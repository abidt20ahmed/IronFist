...
const Class = ({ img, name, title, rate, description }) => {
    return (
        <div className="max-w-md bg-white border border-gray-200 rounded-md shadow dark:bg-gray-800 dark:border-gray-700 group overflow-hidden">
            <a href="#">
                <img className="rounded-t-md group-hover:scale-110 overflow-hidden transition  object-cover" src={img} alt="" />
            </a>
            <div className="p-5 py-">
                <div className='flex justify-between items-center py-3'>
                    <p className=' bg-red-600 text-white py-2 px-3'>{name}</p>
            ...
            <div className='flex justify-between items-center text-gray-500 py-3 px-5'>
                <div className='flex justify-between items-center gap-3'>
                    <img className="h-14 w-14 rounded-full object-cover" src={img} alt="" />
