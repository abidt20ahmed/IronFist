    ...
    return (
        <div>
            ...
            <div className=' w-16 ml-auto'>
                <button onClick={handleClose} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-1 text-sm text-white rounded-lg sm:hidden bg-slate-200 hover:bg-slate-500 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-200 dark:bg-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    <span className="sr-only">Open sidebar</span>
                    <svg className="w-6 h-6 text-gray-800 dark:text-gray-400" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen  ${close && 'transition-transform -translate-x-full'} sm:translate-x-0`} aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-red-600 dark:bg-slate-950">
                    ...
                    <div className='flex flex-col items-center justify-center mt-10 mb-20'>
                        ...
                        <p className=' text-2xl font-bold text-white dark:text-gray-400'>{user?.displayName}</p>
                    </div>
